...
document.getElementById('radioForm').addEventListener('submit', function(event) {
    ...
    switch (selectedOption) {
        case 'option1':
            this.action = 'admin_insert_transactions.php'; // Replace 'page1.php' with the actual URL for Option 1
            break;
        case 'option2':
            this.action = 'admin_new_customer_transactions.php'; // Replace 'page2.php' with the actual URL for Option 2
            break;
        default:
