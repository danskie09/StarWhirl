...
<body>
    ...
    <p><strong>Customer Name:</strong> <?php echo $transaction['customer_firstname']." ".$transaction['customer_lastname']; ?></p>
        ...
        <button type="submit" name="generateReceipt" href="admin_generateReceipt.php">Generate Receipt</button>
    </form>
    <br>
    <a href="admin_UnpaidTransactions.php">Back to Ongoing Transactions</a>
