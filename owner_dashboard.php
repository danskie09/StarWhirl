...
$sql = "SELECT firstname, lastname FROM owner WHERE owner_id = $owner_id";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $owner_firstname = $row['firstname'];
    $owner_lastname = $row['lastname'];
} else {
    // Handle the case where owner data is not found
    $owner_firstname = 'Unknown';
    $owner_lastname = 'Unknown';
}
...
?>
<h2>Owner Dashboard: <?php echo $owner_firstname . ' ' . $owner_lastname; ?></h2>
...
<a href="owner_transaction_selection.php">Insert a Transaction</a>  <br>
<a href="staff_signup.php">Add Staff</a><br>
<a href="owner_viewStaff.php">View All Staff</a><br>
<a href="owner_viewCustomer.php">View All Customer</a><br>
    <a href="view_all_transactions.php">View all transactions</a><br>
    <a href="owner_ongoingTransactions.php">Ongoing Transactions</a>  <br>
    <a href="owner_unpaidTransactions.php">Unpaid Transactions</a>  <br>
    <a href="owner_stock_process.php">Add Stocks</a>  <br>
    <a href="owner_view_stocks.php">View Stocks</a>   <br>
    <a href="owner_update_lpg.php">Update LPG</a>  <br>
    <a href="owner_view_lpg.php">View LPG Status</a>  <br>
    <a href="owner_sales_history.php">Sales History</a>  <br>
    
    <a href="owner_schedule.php">Schedule Maintenance</a> <br>
